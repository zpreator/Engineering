...
def GetData():
    ...
    data = np.loadtxt(u"/Repos/Engineering/ME342NumAnalysis/Unit3/CurveFitData.txt", unpack=True)
    return data
...
def Display(data, a, b):
    """ Displays the discrete data along with the trendline"""
    plt.plot(data[0], data[1], 'b.')
    plt.plot(data[0], [Equation(i, a, b) for i in data[0]], 'r')
    plt.show()
