...
def Main(): 
    ...
    Display([GS[0], GS[2]], '^:' , label='Galvanized Steel', save=False, done=True, xLabel=r'Flow Rate $(L/s)$', yLabel=r'Pressure Drop $(psi)$', plotLabel='PressureVFlow')
    ...
    Display([GS[5], GS[6]], 'm^:',  label=r'Galvanized Steel f_{theo}', save=False, done=True, xLabel=r'Flow Rate $(L/s)$', yLabel=r'Pressure Drop $(psi)$', plotLabel='PressureVFlow')
